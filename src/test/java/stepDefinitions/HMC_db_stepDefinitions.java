...
public class HMC_db_stepDefinitions {
    ...
    public void user_gets_the_data_in_the_table (String table, String field) throws SQLException {
        String query = "SELECT "+field+" FROM "+ table;
        resultSet = statement.executeQuery(query);
    }
    @Given("user prints the data on the column {string}")
    public void user_prints_the_data_on_the_column (String field) throws SQLException {
        ...
        while(resultSet.next()){
            System.out.println(sira+". record : " + resultSet.getString(field));
            sira++;
        }
